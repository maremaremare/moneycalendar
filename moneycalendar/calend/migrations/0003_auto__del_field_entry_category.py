...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'calend_entry', 'category_id')


    def backwards(self, orm):
        # Adding field 'Entry.category'
        db.add_column(u'calend_entry', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='aa', related_name='expense_category', to=orm['calend.Category']),
                      keep_default=False)
