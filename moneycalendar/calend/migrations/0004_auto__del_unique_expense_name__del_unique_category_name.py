...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'calend_category', ['name'])

        # Removing unique constraint on 'Expense', fields ['name']
        db.delete_unique(u'calend_expense', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Expense', fields ['name']
        db.create_unique(u'calend_expense', ['name'])

        # Adding unique constraint on 'Category', fields ['name']
        db.create_unique(u'calend_category', ['name'])
