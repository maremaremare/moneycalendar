    ...
    $.extend(Overlay.prototype, {
      ...
      renderTextOnOverlay: function () {
        ...
        for (i = 0, l = this.strategies.length; i < l; i++) {
          ...
          if (i == 0) {text = text.replace(match, function (a, b) {
          
            //console.log(b)

            return '  <span style="' + 'text-shadow:  0 0 1em green;' + '">' + b + '</span>  ';
          });}

          else if (i == 1) {

text = text.replace(match, function (a) {
          
            console.log(a)

            return '<span style="' + 'text-shadow:  0 0 1em red; ' + '">' + a + '</span>';
          });
